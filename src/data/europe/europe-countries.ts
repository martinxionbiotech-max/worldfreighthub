...
export const europeCountries: Country[] = [
  ...
  },
  {
    ...
    typicalCargo: [
      "Re-export and transshipment cargo",
      "Consumer electronics",
      "General merchandise via Rotterdam",
    ],
    importRisks: [
      "21% VAT standard rate",
      "EU customs union compliance",
      "Rotterdam congestion at peak season",
    ],
    bestPort:
      "Rotterdam — Europe's largest port and the default gateway for Dutch and inland European distribution.",
    inlandLogistics:
      "Rotterdam feeds the Netherlands, Germany and Central Europe by Rhine barge and rail — the strongest inland distribution network in Europe.",
    decisionGuide:
      "The Netherlands is Europe's distribution hub. Use Rotterdam for re-export and Central European distribution; 21% VAT applies unless goods sit in a customs warehouse or transit.",
  },
  {
    slug: 'spain',
    updated: '2026-09-06',
  ...
  },
  {
    ...
    typicalCargo: [
      "Fashion, footwear and leather goods",
      "Machinery and industrial components",
      "Furniture and home goods",
    ],
    importRisks: [
      "22% VAT — among the EU's highest standard rates",
      "EORI number required for customs clearance",
      "CE conformity for regulated goods",
    ],
    bestPort:
      "Genoa — China's primary gateway for the industrial north (Milan and Turin hinterland).",
    inlandLogistics:
      "Genoa feeds Milan and the industrial north by rail and road; northern Italy is the main manufacturing and consumption base.",
    decisionGuide:
      "Italy's 22% VAT makes landed-cost modelling essential. Route via Genoa for the industrial north; secure EORI registration and CE conformity before sailing.",
  },
  {
    slug: 'poland',
    updated: '2026-09-06',
  ...
  },
  {
    ...
    typicalCargo: [
      "General cargo and construction materials",
      "Consumer goods for the Greek market",
      "Transshipment cargo via Piraeus",
    ],
    importRisks: [
      "24% VAT — the EU's highest standard rate",
      "EORI plus EU customs compliance",
      "Piraeus congestion at peak season",
    ],
    bestPort:
      "Piraeus — the main gateway and a fast-growing transshipment hub (COSCO-operated).",
    inlandLogistics:
      "Piraeus serves Athens and mainland Greece, with limited rail reach into the Balkans.",
    decisionGuide:
      "Greece's 24% VAT is the EU's highest, so landed cost matters. Route via Piraeus for the Greek market; consider it a Southeast Europe entry point when Balkan distribution is needed.",
  },
  {
    slug: "ireland",
    updated: "2026-09-07",
