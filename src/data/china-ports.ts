...
export const chinaPorts: Port[] = [
  {
    ...
    faqs: [
      ...
      { q: 'How long does sea freight take from Shanghai to the GCC?', a: 'Direct Shanghai-to-GCC sailings typically run 14–20 days port-to-port, depending on the destination — Jebel Ali and Jeddah are among the fastest at 14–18 days, while Qatar, Kuwait and Bahrain usually transship and add 5–10 days.' },
    ],
    updated: '2026-09-01',
  },
  {
    ...
    faqs: [
      ...
      { q: 'Should I ship from Ningbo-Zhoushan or Shanghai?', a: 'If your cargo originates in Zhejiang, Ningbo-Zhoushan usually saves inland trucking and is often slightly cheaper on Gulf lanes, with comparable direct sailings. If your goods come from further north in the Yangtze Delta, Shanghai\'s denser schedule is the safer default.' },
    ],
    updated: '2026-09-01',
  },
  {
    ...
    faqs: [
      ...
      { q: 'Yantian or Shekou — which terminal for GCC freight?', a: 'Yantian is the deep-water workhorse for Gulf-bound FCL with the most direct ocean services. Shekou suits electronics and cargo needing fast cross-border moves with Hong Kong. Specify the exact terminal on the booking, not just “Shenzhen”.' },
    ],
    updated: '2026-09-01',
  },
  {
    ...
    faqs: [
      ...
      { q: 'When should I ship from Guangzhou instead of Shenzhen?', a: 'Choose Guangzhou (Nansha) when your goods originate in western Guangdong or reach the terminal by river barge — it can be cheaper and less congested. For most Gulf FCL, Shenzhen-Yantian still offers more direct sailings.' },
    ],
    updated: '2026-09-01',
  },
  {
    ...
    faqs: [
      ...
      { q: 'What cargo suits Qingdao as the GCC origin port?', a: 'Qingdao is the natural origin for Shandong and Bohai heavy industry — machinery, tires, steel and chemicals. Its automated terminal gives reliable cut-offs, and it avoids long inland trucking to Shanghai for north-China goods.' },
    ],
    updated: '2026-09-01',
  },
  {
    ...
    faqs: [
      ...
      { q: 'Does winter weather affect Tianjin shipments to the GCC?', a: 'Tianjin is the northernmost major gateway and can be weather-affected in winter, so build a schedule buffer for December–February sailings. For the rest of the year it is the correct origin for Beijing-Tianjin-Hebei steel, machinery and vehicles.' },
    ],
    updated: '2026-09-01',
  },
  {
    ...
    faqs: [
      ...
      { q: 'Is Xiamen a viable origin for Gulf freight?', a: 'Yes, for Fujian-based suppliers of footwear, textiles and ceramics. It has fewer direct Gulf sailings than Shanghai or Shenzhen and usually requires transshipment, but it cuts inland trucking for Fujian light industry.' },
    ],
    updated: '2026-09-01',
  },
];
