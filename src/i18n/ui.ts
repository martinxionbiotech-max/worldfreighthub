...
const en: Dict = {
  ...
  'nav.freightrates': 'Freight Rates',
  ...
  'footer.advertising': 'Advertising Disclosure',
  'footer.corrections': 'Corrections',
  'footer.dataChangelog': 'Data Changelog',
...
const ar: Dict = {
  ...
  'nav.freightrates': 'أسعار الشحن',
  'nav.intelligence': 'مركز المعلومات',
  'nav.europe': 'أوروبا',
  'nav.evidence': 'الأدلة',
  'nav.about': 'من نحن',
